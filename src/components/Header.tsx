...
function Header() {
  return (
    <header className="watcha-bg-dark px-4 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* 프로필 버튼 */}
          <button className="bg-watcha-red text-white px-3 py-1 rounded text-sm font-medium hover:opacity-80 transition-opacity">
            로그인
          </button>
        </div>
      </div>
